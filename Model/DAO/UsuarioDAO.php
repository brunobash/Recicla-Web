...
class UsuarioDAO {
    ...
    public function cadastrarUsuario($usuario) {
        try {
            ...
            $sql = "INSERT INTO usuario(nome,   login, senha, email, telefone, dataNasc, cpf, perfil, celular)"
                             . "VALUES (:nome, :login, :senha, :email, :telefone, :dataNasc, :cpf, :perfil, :celular)";
    ...
    public function atualizarUsuario($usuario) {
        try {
            ...
            $sql = "UPDATE USUARIO SET nome = :nome, login = :login,"
                    . "perfil=:perfil, senha=:senha, email=:email, telefone=:telefone, dataNasc=:dataNasc, cpf=:cpf, id=:id WHERE id = :id";
